...
inline decimal128_t operator~(const decimal128_t& operand) {
	decimal128_t result = dec128_from_hilo(~dec128_high_bits(operand), ~dec128_low_bits(operand));
	return result;
}

inline decimal128_t operator+(const decimal128_t& left, const decimal128_t& right) {
